                    ...
                    <div class="tt-page-header">
                        <div class="d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title mb-3 mb-lg-0">
                                <h1 class="h4 mb-lg-1">{{ localize('Add New Page') }}</h1>
                                <ol class="breadcrumb breadcrumb-angle text-muted">
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('writebot.dashboard') }}">{{ localize('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('admin.pages.index') }}">{{ localize('Pages') }}</a>
                                    </li>
                                    <li class="breadcrumb-item">{{ localize('Add Page') }}</li>
                                </ol>
                            </div>
                            <div class="tt-action">
                            </div>
                    ...
                    <form action="{{ route('admin.pages.store') }}" method="POST" class="pb-650">
                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <label for="title" class="form-label">{{ localize('Page Title') }}
...
@endsection
@section('scripts')
    @include('backend.pages.common.ai-editor')
@endsection
